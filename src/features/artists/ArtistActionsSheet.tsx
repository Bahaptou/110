...
/** Bottom sheet opened from the "⋯" button on an artist's screen. Mirrors TrackActionsSheet. */
export function ArtistActionsSheet({
  visible,
  onClose,
  onChangeImage,
  onRename,
          ...
          <SafeAreaView edges={['bottom']}>
            <View style={styles.sheet}>
              ...
              <Pressable style={[styles.action, styles.actionLast]} onPress={onDelete}>
                <Text style={styles.actionLabelDanger}>Supprimer l'artiste</Text>
              </Pressable>
            </View>
          </SafeAreaView>
        </Pressable>
